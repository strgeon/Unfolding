...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    SimplePointMarker mark = new SimplePointMarker();
	...
	{	
		...
		this.rect(20, 20, 150, 400);
		this.fill(255,0,0);
		this.ellipse(40,40,30,30);
		this.fill(255,255,0);
		this.ellipse(40,100,15,15);
		this.fill(0,0,255);
		this.ellipse(40,140,5,5);
		this.fill(0,0,0);
		this.text(">5.0", 60,45);
		this.text(">4.0", 60,105);
		this.text("<4.0", 60,145);
		fill(255,255,255);
	}
}
